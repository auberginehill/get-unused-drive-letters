...
<table>
    <tr>
        ...
        <td style="padding:6px">
            <ul>
                <li>Displays general computer information, a list of optical drives, a partition table, volumes list and the used and unused drive letters in console. In addition to that... </li>
            </ul>
        </td>
    </tr>
    <tr>
